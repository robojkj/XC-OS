...
public :
    ...
    typedef enum{
        ...
        SYS_CTL2_BIT_CurrentThreshold = B11111000,
        ...
        10：3S
        11：4S*/
        SYS_CTL3_BIT_LongPressTimeSet = B11000000,
        ...
        01:16s
        00: 8s*/
        SYS_CTL4_BIT_ShutdownTimeSet =		B11000000,
		SYS_CTL4_BIT_ShutdownTimeSet_64S =	B11000000,
		SYS_CTL4_BIT_ShutdownTimeSet_32S =	B10000000,
		SYS_CTL4_BIT_ShutdownTimeSet_16S =	B01000000,
		SYS_CTL4_BIT_ShutdownTimeSet_8S =	B00000000,
        ...
        置为最高，优先对外部负载充电。*/
        Charger_CTL1_BIT_ChargeUndervoltageRingSet = B00001100,
        ...
        01：4.3V 电池
        00: 4.2V 电池*/
        Charger_CTL2_BIT_BatteryTypeSet = 		B01100000,
		Charger_CTL2_BIT_BatteryTypeSet_4V2 =	B00000000,
		Charger_CTL2_BIT_BatteryTypeSet_4V3 =	B00100000,
		Charger_CTL2_BIT_BatteryTypeSet_4V35 =	B01000000,
        ...
        流小于 200MA 才认为是电芯充饱了；*/
        Charger_CTL2_BIT_ConstantVoltageForcingSet =		B00000110,
		Charger_CTL2_BIT_ConstantVoltageForcingSet_NONE =	B00000000,
		Charger_CTL2_BIT_ConstantVoltageForcingSet_14MV =	B00000010,
		Charger_CTL2_BIT_ConstantVoltageForcingSet_28MV =	B00000100,
		Charger_CTL2_BIT_ConstantVoltageForcingSet_42MV =	B00000110,
        ...
        CHG_DIG_CTL5_BIT_ChargeCurrentSet = B00011111,
        ...
        10: VREF
        11 : Reserved*/
        MFP_CTL0_BIT_LIGHT_Sel =		B00110000,
		MFP_CTL0_BIT_LIGHT_Sel_WLED =	B00000000,
		MFP_CTL0_BIT_LIGHT_Sel_GPIO2 =	B00010000,
		MFP_CTL0_BIT_LIGHT_Sel_VREF =	B00100000,
        ...
        10: Reserved
        11: Reserved*/
        MFP_CTL0_BIT_L4_Sel =		B00001100,
		MFP_CTL0_BIT_L4_Sel_L4 =	B00000000,
		MFP_CTL0_BIT_L4_Sel_GPIO1 =	B00000100,
        ...
        10: Reserved
        11 : Reserved*/
        MFP_CTL0_BIT_L3_Sel =		B00000011,
		MFP_CTL0_BIT_L3_Sel_L3 =	B00000000,
		MFP_CTL0_BIT_L3_Sel_GPIO0 =	B00000001,
        ...
        10: Reserved
        11: Reserved*/
        MFP_CTL1_BIT_VSET_Sel = B00001100,
        ...
        10: Reserved
        11: Reserved*/
        MFP_CTL1_BIT_RSET_Sel = B00000011,
        
        /*************************** GPIO_CTL1 ***************************/
        /*GPIO[4:0]input enable
        0：Disable
        1：Enable*/
        GPIO_CTL1_BIT_GPIO_INEN = B00011111,
        ...
        GPIO_CTL2_BIT_GPIO_OUTEN = B00011111,
        
        /*************************** GPIO_CTL3 ***************************/
        /*GPIO[4:0] DATA */
        GPIO_CTL3_BIT_GPIO_DAT = B00011111,
        ...
        BATVADC_DAT0_BIT_BATVADC_High_6Bit = B00111111,
        ...
        BATIADC_DAT0_BIT_BATVADC_High_6Bit = B00111111,
        ...
        BATOCV_DAT1_BIT_BATOCV_High_6Bit = B00111111,
        ...
        101: 充饱状态
        110: 充电超时状态*/
        Reg_READ0_BIT_ChargeStatusFlags = B11100000,
